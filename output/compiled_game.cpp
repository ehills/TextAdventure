...
Location inventory("Inventory", "Description of the inventory");Player* andy = new Player();andy->setLocation(&garden);andy->setInventory(&inventory);andy->setMaxItems(4);Item lamp("A lamp", "A rusty old lamp but looks like it still works");
